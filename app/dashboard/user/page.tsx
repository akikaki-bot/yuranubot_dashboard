                ...
                (
                    <div className="flex flex-col gap-4 w-full">
                        <div className="flex flex-row gap-4 w-full items-center mt-4">
                            <div className="h-10 w-10 animate-spin border-[3px] border-green-400 rounded-full border-t-transparent" />
                            <p className="text-center">ダッシュボードを読み込んでいます...</p>
                        </div>
                    </div>
                ) :
                (
                    <div className="flex flex-col gap-4">
                        <div className="flex flex-col gap-4 my-2">
                            <div className="mt-2 p-3 px-5 flex flex-row gap-4 items-center rounded-xl bg-yellow-100 bg-opacity-65 text-orange-500">
                                <p className="text-orange-500 text-2xl font-bold text-center">注意</p>
                                <p>
                                    ・一部設定はサーバー側で設定されており、ユーザー側で特段設定する必要のないものがあります。<br />
                                    ・ここでは実装がされていますが、Bot側で実装されていない機能等がある可能性があり、Bot側で正常に表示されない等の不具合が生じる可能性があります。
                                </p>
                            </div>
